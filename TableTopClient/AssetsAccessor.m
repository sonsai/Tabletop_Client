...
- (void)getAssetsFromGroup:(ALAssetsGroup *)group withFilter:(ALAssetsFilter *)filter{
    ...
    NSMutableArray *videoAssets = [NSMutableArray new];
    ...
    if([self.delegate respondsToSelector:@selector(assetsDidLoadByGroup:Video:)]){
        [self.delegate assetsDidLoadByGroup:photoAssets Video:videoAssets];
    }
}
